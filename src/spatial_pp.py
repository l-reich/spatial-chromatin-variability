...
segmented_cells = pd.read_csv("../data/spatial_data/MERFISH_MOp/processed_data/segmented_cells_mouse1sample4.csv").reset_index().rename(columns={"index": "cell_id"})
...
adata_filtered.write(filename="../h5ad_files/sp_pp.h5ad")